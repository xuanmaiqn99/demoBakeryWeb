		...
		<div class="row">
			<div class="col-sm-3">
				<div class="widget">
					...
					<a href="">Instagram: meimemai</a>
					<!-- <div id="beta-instagram-feed">meimemai</div> -->
				</div>
			</div>
			<div class="col-sm-2">
				<div class="widget">
					...
					<div class="widget">
						...
						<div>
							<div class="contact-info">
								...
								<p>Phone: </p>
								<p>Nemo enim ipsam voluptatem quia voluptas sit asnatur aut odit aut fugit.</p>
							</div>
						</div>
					</div>
				</div>
...
<div class="copyright">
	<div class="container">
		<p class="pull-left">Xuan Mai (&copy;) 2020</p>
