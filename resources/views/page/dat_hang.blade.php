                ...
                <div class="col-sm-6">
                    <div class="your-order">
                                ...
                                <div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="color-gray your-order-info">Price:{{number_format($cart['price'])}} đ </span>
                            ...
                            <div class="your-order-item">
                                ...
                                <div class="pull-right">
                                    <h5 class="color-black">
                                        @if(Session::has('cart'))
                                        {{number_format($totalPrice)}} @else 0 @endif đ</h5>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        ...
                        <div class="text-center"><button type="submit" class="beta-btn primary" href="#">
                                Đặt hàng <i class="fa fa-chevron-right"></i></button>
                        </div>
                    </div> <!-- .your-order -->
                </div>
            </div>
